...
<div class="container-fluid text-center" >    
  <div class="row content">
    <div class="col-sm-2 sidenav" id="left">
      ...
      <a href="adminhome.php"><li class="active" id="s1">Profile</li></a>
      <a href="add_room.php"><li>Room Details</li></a>
 ...
 <?php
        ...
        include('db.php');
        $res=mysqli_query($con,"select * from patient where id ='1'");
 ...
 ?>
    ...
    <div class="col-sm-8 text-left" id="main_content"> 
       <div class="page-header">
			<h3>Profile</h3>
			<div class="jumbotron">
          <h2>Name : <?php echo $res1["name"]; ?> </h2>
          <br>
          <h3>Details</h3>
          
            <h4 style="padding-left: 100px;">Address : <?php echo $res1["address"];?></h4>
            <h4 style="padding-left: 100px;">Sex : <?php echo $res1["sex"];?></h4>
            <h4 style="padding-left: 100px;">Age : <?php echo $res1["age"];?></h4>
            <h4 style="padding-left: 100px;">Disease : <?php echo $res1["disease"];?></h4>
