...
<div class="container-fluid text-center" >    
  <div class="row content">
    <div class="col-sm-2 sidenav" id="left">
      ...
      <a href="add_stud.php"><li class="active"  id="s7">Add Student</li></a>
...
<form class="form-horizontal" method="post">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-3 col-sm-5">
        <button type="submit" name="sub" id="sub" class="btn btn-success">Add Student</button>
      </div>
    </div>
    ...
    <?php
      if (isset($_POST['sub']))
      {
        ...
        if (mysqli_query($con, "INSERT INTO `std_details` VALUES ('$a','$b','$c','$d','0')") && mysqli_query($con, "INSERT INTO `login` VALUES ('$a','$e','$f','user')")) {
            ?>
            <script> alert("The student is successfully added");</script>
          <?php
        } else {
            ?>
            <script> alert("Couldn't add student");</script>
          <?php
        }
      }  
