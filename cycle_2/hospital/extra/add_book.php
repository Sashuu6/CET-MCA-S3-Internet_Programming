...
<div class="container-fluid text-center" >    
  <div class="row content">
    <div class="col-sm-2 sidenav" id="left">
      ...
      <a href="add_book.php"><li class="active" id="s2">Add Book</li></a>
...
<form class="form-horizontal" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control"  placeholder="Enter book id" name="bid">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-6">          
        <input type="text" class="form-control" placeholder="Enter name of author" name="author">
      </div>
    </div>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-3 col-sm-5">
        <button type="submit" name="sub" id="sub" class="btn btn-primary">Add book</button>
      </div>
    </div>
    ...
    <?php
      if (isset($_POST['sub']))
      {
        ...
        if (mysqli_query($con, "INSERT INTO `book_details`(`id`, `name`, `author`, `genre`) VALUES ('$a','$b','$c','$d')")) {
            ?>
            <script> alert("The book is successfully added");</script>
          <?php
        } else {
            ?>
            <script> alert("Couldn't add book");</script>
          <?php
        }
      }  
